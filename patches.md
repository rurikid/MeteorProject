...
**26Apr2018** - rurikid
```
> removed 'Reports' navigation options
> restored 'Generate Report' button in TeamTimesheets
> restored schema to not rely on user info within every timechunk
> relocated patch notes to new file
> removed deprecated files again
```
